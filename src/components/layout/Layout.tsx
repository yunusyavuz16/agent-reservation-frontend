      ...
      <header className="fixed top-0 left-0 right-0 bg-blue-600 text-white shadow-md z-50">
        <div className="flex items-center justify-between px-4 py-2 h-16">
          <div className="flex items-center">
            ...
            <h1 className="hidden md:block text-xl font-semibold whitespace-nowrap ml-2">
              Reservation System
            </h1>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative">
              ...
              >
                <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white font-medium border-2 border-white">
